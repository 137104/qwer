<template>
 <el-dialog :title="info.isAdd ? '添加':'修改'" :visible.sync="info.isShow" width="30%">
<el-form :model="forminfo" ref="form" :rules="rules" label-width="100px">
    ...
    <el-form-item label="状态">
       <el-switch  v-model="forminfo.status" :active-value="1" :inactive-value="2">
     </el-switch>      
    </el-form-item>
    <el-form-item label="">
...
<script>
import{addMenu,editMe} from "@/request/menu"
